...
export const initialPengaturan: PengaturanPortal = {
  ...
  statsItem1Note: "Terdaftar & aktif berproduksi",
  statsItem2Value: "20+",
  ...
  statsItem3Note: "Keahlian fermentasi turun-temurun",
  statsItem4Value: "Bangil & Regional",
  statsItem4Label: "Jangkauan Pasar",
  statsItem4Note: "Pasokan eceran, grosir & kuliner",
